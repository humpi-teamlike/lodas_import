"""
LODAS Importskript  lodas_import_v20
====================================
...
def berechne_soll_aus_zeitnachweis(datei_pfad):
    ...
    Gibt (tages_soll_berechnet, name) zurueck oder (None, name) bei Fehler.
    ...
    # Eindeutige Werktage (Mo-Fr) und Feiertage aus Zeitnachweis-Sheet sammeln
    zn_werktage  = set()
    feiertag_daten = set()
    ...
    # FZA und Urlaub-Tage aus Abwesenheiten-Sheet (Set-Union)
    abw_daten = set()
    try:
        ...
        pass  # Abwesenheiten optional – Fehler werden still ignoriert

    # SOLL-Tage = Union aller belegten Werktage minus Feiertage
    ...
    for i, row in df_raw.iterrows():
        ...
        if "soll" in label and "stunden" in label:
            ...
            if len(werte) >= 3:
                # Differenz-Spalte (3. Wert) direkt verwenden
